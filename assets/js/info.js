...
const DATA = {
  ...
  5: {
    ...
    opts: [
      "毫不猶豫跟著影片實作，期望達到快速減重的成效",
      "懷疑效果，查詢可靠來源驗證影片提到的方法",
      "直接分享給朋友",
    ],
    ans: 1,
    explain:
      "自媒體創作人常藉由誇張效果，吸引觀看率，作為閱聽人要有判斷力以及查證資訊的能力，不可盡信。",
  },
  6: {
    qSize: "40px",
    eSize: "50px",
  ...
  9: {
    ...
    opts: [],
    explain:
      "假贈品常用來收集個資，必須警覺有可能是釣魚網站，這是一種網路詐騙行為，攻擊者會偽裝成合法網站，誘騙使用者點擊連結輸入個人敏感資訊，以進行盜取資料或財產。",
  },
  10: {
    qSize: "50px",
    eSize: "50px",
